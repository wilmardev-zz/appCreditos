                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Create Users just here!</h1></p>
                            <p>In this section you can directly create users for later use</p>
                            <p><a class="btn btn-lg btn-primary" href="${pageContext.servletContext.contextPath}/view/users.jsp" role="button">Create User</a></p>
                        </div>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Create Courses just here!</h1>
                            <p>Enter and create new courses filling all the required information: such as your name, value, etc.</p>
                            <p><a class="btn btn-lg btn-primary" href="${pageContext.servletContext.contextPath}/view/courses.jsp" role="button">Go to Courses</a></p>
                        </div>
                    </div>
                </div>
                <div class="item">
